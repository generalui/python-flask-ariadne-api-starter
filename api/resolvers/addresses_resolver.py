...
def resolve_addresses(_, info, distinct=False, paging=None, address1=None, address2=None, city=None, country=None, state=None, zipcode=None):
    ...
    query, count_query = build_address_request(
        requested, distinct=distinct, paging=paging, address_1=address1, address_2=address2, city=city, country=country, state=state, zipcode=zipcode)
